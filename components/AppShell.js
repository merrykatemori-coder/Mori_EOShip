  ...
  return (
    <div>
      <div
        ...
        style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.85) 0%, rgba(240,244,255,0.9) 100%)', height: 50, boxShadow: '0 2px 20px rgba(79,110,247,0.08)', backdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(79,110,247,0.1)' }}
      >
        <Link href="/dashboard" className="flex items-center gap-2" style={{ textDecoration: 'none' }}>
          ...
          <h1 className="text-sm sm:text-base font-semibold tracking-wide" style={{ color: '#0f1b3d' }}>Mori EOShip</h1>
        </Link>
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button onClick={logout} className="flex items-center gap-1 text-xs sm:text-sm font-medium hover:opacity-80 transition-opacity" style={{ color: '#475569' }}>
