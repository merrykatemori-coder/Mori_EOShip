    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(6px)' }}>
      <div className="rounded-xl p-8 max-w-sm text-center modal-animate">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button onClick={onConfirm} className="px-5 py-2.5 rounded-lg text-sm font-semibold text-white transition-all" style={{ background: 'var(--danger)', boxShadow: '0 4px 16px rgba(255,107,129,0.25)' }}>Delete</button>
        </div>
      </div>
    </div>
  );
