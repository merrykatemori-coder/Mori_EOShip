...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen" style={{ background: 'var(--bg)', backgroundImage: "url('/bg.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <form onSubmit={handleLogin} className="rounded-2xl p-8 sm:p-12 w-full max-w-md mx-3 sm:mx-0 text-center" style={{ background: 'rgba(255,255,255,0.7)', border: '1px solid rgba(124,58,237,0.1)', backdropFilter: 'blur(24px)', boxShadow: '0 24px 80px rgba(124,58,237,0.1)' }}>
        <img src="/logo.png" alt="Logo" style={{ width: 60, marginBottom: 12, marginLeft: 'auto', marginRight: 'auto', display: 'block' }} />
        <h1 className="text-3xl font-bold mb-2" style={{ color: '#2d1654' }}>Mori EOShip</h1>
        ...
        <div className="text-left mb-4">
          ...
          <input
            ...
            style={{ border: '1px solid rgba(124,58,237,0.12)', background: 'rgba(255,255,255,0.85)' }}
        ...
        <button
          ...
          style={{ background: loading ? 'var(--grey)' : 'linear-gradient(135deg, #7c3aed, #a855f7)', boxShadow: loading ? 'none' : '0 4px 20px rgba(124,58,237,0.3)' }}
        >
